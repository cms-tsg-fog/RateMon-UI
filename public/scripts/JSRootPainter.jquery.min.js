var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(c,k,m){c instanceof String&&(c=String(c));for(var h=c.length,q=0;q<h;q++){var r=c[q];if(k.call(m,r,q,c))return{i:q,v:r}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
...
$jscomp.polyfill=function(c,k,m,h){if(k){m=$jscomp.global;c=c.split(".");for(h=0;h<c.length-1;h++){var q=c[h];q in m||(m[q]={});m=m[q]}c=c[c.length-1];h=m[c];k=k(h);k!=h&&null!=k&&$jscomp.defineProperty(m,c,{configurable:!0,writable:!0,value:k})}};$jscomp.polyfill("Array.prototype.find",function(c){return c?c:function(c,m){return $jscomp.findInternal(this,c,m).v}},"es6","es3");
...
if("object"!=typeof JSROOT.Painter)throw Error("JSROOT.Painter not defined","JSRootPainter.jquery.js");c(jQuery,jQuery.ui,d3,JSROOT)}})(function(c,k,m,h){function q(a){h.MDIDisplay.call(this,a);this.cnt=0}function r(a){h.MDIDisplay.call(this,a);this.cnt=0}function x(a){h.MDIDisplay.call(this,a);this.cnt=0}h.sources.push("jq2d");"function"===typeof define&&define.amd&&h.loadScript("$$$style/jquery-ui.css");h.Painter.createMenu=function(a,b){b||"function"!==typeof a||(b=a,a=null);var d={painter:a,element:null,
code:"",cnt:1,funcs:{},separ:!1,add:function(a,b,d,l){if("separator"==a)this.code+="<li>-</li>",this.separ=!0;else if(0==a.indexOf("header:"))this.code+="<li class='ui-widget-header' style='padding:3px; padding-left:5px;'>"+a.substr(7)+"</li>";else if("endsub:"==a)this.code+="</ul></li>";else{var e="",f="</li>";l=l?" title='"+l+"'":"";0==a.indexOf("sub:")&&(a=a.substr(4),f="<ul>");"function"==typeof b&&(d=b,b=a);0==a.indexOf("chk:")?(e="<span class='ui-icon ui-icon-check' style='margin:1px'></span>",
a=a.substr(4)):0==a.indexOf("unk:")&&(e="<span class='ui-icon ui-icon-blank' style='margin:1px'></span>",a=a.substr(4));e=0==c.ui.version.indexOf("1.10")||0==c.ui.version.indexOf("1.9")?'<a href="#">'+e+a+"</a>":0==c.ui.version.indexOf("1.11")?e+a:"<div"+l+">"+e+a+"</div>";this.code+="<li cnt='"+this.cnt+(void 0!==b?"' arg='"+b:"")+"'>"+e+f;"function"==typeof d&&(this.funcs[this.cnt]=d);this.cnt++}},addchk:function(a,b,d,c){return this.add((a?"chk:":"unk:")+b,d,c)},size:function(){return this.cnt-
1},addDrawMenu:function(a,b,d){b||(b=[]);0==b.length&&b.push("");var e=!1;0==a.indexOf("nosub:")&&(e=!0,a=a.substr(6));if(1===b.length)return"inspect"===b[0]&&(a=a.replace("Draw","Inspect")),this.add(a,b[0],d);e||this.add("sub:"+a,b[0],d);for(var f=0;f<b.length;++f){var c=b[f];""==c&&(c="&lt;dflt&gt;");var g=f+1;if(5<b.length&&0<c.length)for(;g<b.length&&0==b[g].indexOf(c);)g++;e&&(c=a+" "+c);if(g<f+2)this.add(c,b[f],d);else{this.add("sub:"+c,b[f],d);for(f+=1;f<g;++f)this.add(b[f],b[f],d);this.add("endsub:");
f=g-1}}e||this.add("endsub:")},remove:function(){null!==this.element&&(this.element.remove(),this.close_callback&&this.close_callback(),document.body.removeEventListener("click",this.remove_bind));this.element=null}};d.remove_bind=d.remove.bind(d);d.show=function(a,b){this.remove();"function"==typeof b&&(this.close_callback=b);document.body.addEventListener("click",this.remove_bind);(b=document.getElementById("root_ctx_menu"))&&b.parentNode.removeChild(b);c(document.body).append('<ul class="jsroot_ctxmenu">'+
this.code+"</ul>");this.element=c(".jsroot_ctxmenu");var f=this;this.element.attr("id","root_ctx_menu").css("left",a.clientX+window.pageXOffset).css("top",a.clientY+window.pageYOffset).css("position","absolute").menu({items:"> :not(.ui-widget-header)",select:function(a,b){a=b.item.attr("arg");b=(b=b.item.attr("cnt"))?f.funcs[b]:null;f.remove();"function"==typeof b&&("painter"in d?b.bind(f.painter)(a):b(a))}});var e=b=null;a.clientX+this.element.width()>c(window).width()&&(b=c(window).width()-this.element.width()-
20);a.clientY+this.element.height()>c(window).height()&&(e=c(window).height()-this.element.height()-20);null!==b&&this.element.css("left",(0<b?b:0)+window.pageXOffset);null!==e&&this.element.css("top",(0<e?e:0)+window.pageYOffset)};h.CallBack(b,d);return d};k=h.BrowserLayout;k.prototype.SetBrowserTitle=function(a){var b=m.select("#"+this.gui_div+" .jsroot_browser");b.empty()||b.select(".jsroot_browser_title").text(a)};k.prototype.ToggleBrowserKind=function(a){if(this.gui_div){if(!a){if(!this.browser_kind)return;
a="float"===this.browser_kind?"fix":"float"}var b=m.select("#"+this.gui_div+" .jsroot_browser"),d=c(b.node()).find(".jsroot_browser_area"),f=this;"float"===this.browser_kind?d.css("bottom","0px").css("top","0px").css("width","").css("height","").toggleClass("jsroot_float_browser",!1).resizable("destroy").draggable("destroy"):"fix"===this.browser_kind&&(b.select(".jsroot_v_separator").remove(),d.css("left","0px"),m.select("#"+this.gui_div+"_drawing").style("left","0px"),b.select(".jsroot_h_separator").style("left",
"0px"),m.select("#"+this.gui_div+"_status").style("left","0px"),f.CheckResize());this.browser_kind=a;this.browser_visible=!0;"float"===a?(d.css("bottom","40px").toggleClass("jsroot_float_browser",!0).resizable({containment:"parent",minWidth:100,resize:function(a,b){f.SetButtonsPosition()},stop:function(a,b){7>c(this).parent().innerHeight()-b.position.top-b.size.height&&c(this).css("height","").css("bottom",0)}}).draggable({containment:"parent",handle:c("#"+this.gui_div).find(".jsroot_browser_title"),
...
a&&d.css("bottom",""))}}};k.prototype.ToggleBrowserVisisbility=function(a){if(this.gui_div&&"string"!==typeof this.browser_visible){var b=m.select("#"+this.gui_div+" .jsroot_browser"),d=b.select(".jsroot_browser_area");if(!d.empty()){var f=b.select(".jsroot_v_separator"),e=m.select("#"+this.gui_div+"_drawing"),g=d.property("last_left"),l=d.property("last_vsepar"),h=d.property("last_drawing");if(this.browser_visible)d.property("last_left",d.style("left")),f.empty()||(d.property("last_vsepar",f.style("left")),
d.property("last_drawing",e.style("left"))),g=(-c(d.node()).outerWidth(!0)-10).toString()+"px",l=c(b.node()).outerWidth(!0),f.empty()&&c(d.node()).offset().left>l/2&&(g=l+10+"px"),l="-10px",h="0px";else{if(a)return;d.property("last_left",null).property("last_vsepar",null).property("last_drawing",null)}var n=this,p=!this.browser_visible,v=a?0:700;this.browser_visible="changing";d.transition().style("left",g).duration(v).on("end",function(){a||(n.browser_visible=p)&&n.SetButtonsPosition()});p||b.select(".jsroot_browser_btns").transition().style("left",
"7px").style("top","7px").duration(v);f.empty()||(f.transition().style("left",l).duration(v),e.transition().style("left",h).duration(v).on("end",this.CheckResize.bind(this)));this.status_layout&&"fix"==this.browser_kind&&(b.select(".jsroot_h_separator").transition().style("left",h).duration(v),b.select(".jsroot_status_area").transition().style("left",h).duration(v))}}};k.prototype.Toggle=function(a){"changing"!==this.browser_visible&&(a===this.browser_kind?this.ToggleBrowserVisisbility():this.ToggleBrowserKind(a))};
k.prototype.DeleteContent=function(){var a=m.select("#"+this.gui_div+" .jsroot_browser");if(!a.empty()){this.CreateStatusLine("delete");var b=a.select(".jsroot_v_separator");b.empty()||c(b.node()).draggable("destroy");this.ToggleBrowserVisisbility(!0);a.selectAll("*").remove();delete this.browser_visible;delete this.browser_kind;this.CheckResize()}};k.prototype.CreateStatusLine=function(a,b){var d=m.select("#"+this.gui_div+" .jsroot_browser");if(d.empty())return"";var f=this.gui_div+"_status",e=m.select("#"+
f),g=!e.empty();"toggle"===b?b=!g:"delete"===a?(b=!1,a=0,delete this.status_layout):void 0===b&&(b=!0,this.status_layout="app");if(g){if(!0===b||"app"===this.status_layout)return f;d=d.select(".jsroot_h_separator");c(d.node()).draggable("destroy");d.remove();e.remove();delete this.status_layout;this.status_handler&&h.Painter.ShowStatus===this.status_handler&&(delete h.Painter.ShowStatus,delete this.status_handler);this.AdjustSeparator(null,0,!0);return""}if(!1===b)return"";b=m.select("#"+this.gui_div+
"_drawing").style("left");e=d.insert("div",".jsroot_browser_area").attr("id",f).classed("jsroot_status_area",!0).style("position","absolute").style("left",b).style("height","20px").style("bottom",0).style("right",0).style("margin",0).style("border",0);d=d.insert("div",".jsroot_browser_area").classed("jsroot_separator",!0).classed("jsroot_h_separator",!0).style("position","absolute").style("left",b).style("right",0).style("bottom","20px").style("height","5px");var l=this;c(d.node()).draggable({axis:"y",
cursor:"ns-resize",containment:"parent",helper:function(){return c(this).clone().css("background-color","grey")},drag:function(a,b){l.AdjustSeparator(null,-b.position.top)},stop:function(a,b){l.CheckResize()}});a&&"string"!==typeof a||(a=this.last_hsepar_height||20);this.AdjustSeparator(null,a,!0);if("app"==this.status_layout)return f;this.status_layout=new h.GridDisplay(f,"horizx4_1213");a=["object name","object title","mouse coordinates","object info"];for(e=0;4>e;++e)m.select(this.status_layout.GetFrame(e)).attr("title",
a[e]).style("overflow","hidden").append("label").attr("class","jsroot_status_label");this.status_handler=this.ShowStatus.bind(this);h.Painter.ShowStatus=this.status_handler;return f};k.prototype.AdjustSeparator=function(a,b,d,f){if(this.gui_div){var e=m.select("#"+this.gui_div+" .jsroot_browser");null===b&&f&&!e.select(".jsroot_h_separator").empty()&&(b=e.select(".jsroot_h_separator").style("bottom"),b="string"==typeof b&&b.indexOf("px")==b.length-2?b.substr(0,b.length-2):null);if(null!==b){b=parseInt(b);
f=e.select(".jsroot_h_separator");var g=0;f.empty()||(0>b&&(b+=c(e.node()).outerHeight(!0)-5),5>b&&(b=5),this.last_hsepar_height=b,f.style("bottom",b+"px").style("height","5px"),m.select("#"+this.gui_div+"_status").style("height",b+"px"),g=b+5+"px");m.select("#"+this.gui_div+"_drawing").style("bottom",g)}null!==a&&(a=parseInt(a),50>a&&(a=50),e.select(".jsroot_browser_area").style("width",a-5+"px"),m.select("#"+this.gui_div+"_drawing").style("left",a+5+"px"),e.select(".jsroot_h_separator").style("left",
a+5+"px"),m.select("#"+this.gui_div+"_status").style("left",a+5+"px"),e.select(".jsroot_v_separator").style("left",a+"px").style("width","5px"));d&&this.CheckResize()}};k.prototype.ShowStatus=function(a,b,d,f){if(this.status_layout&&(c(this.status_layout.GetFrame(0)).children("label").text(a||""),c(this.status_layout.GetFrame(1)).children("label").text(b||""),c(this.status_layout.GetFrame(2)).children("label").text(f||""),c(this.status_layout.GetFrame(3)).children("label").text(d||""),!this.status_layout.first_check)){this.status_layout.first_check=
...
e="_childs"in a,c=h.getDrawHandle(a._kind),l="",t="",n=!1,p=!1,m=this.itemFullName(a);null!==c&&("icon"in c&&(l=c.icon),"icon2"in c&&(t=c.icon2),0==l.length&&"function"==typeof c.icon_get&&(l=c.icon_get(a,this)),"func"in c||"execute"in c||"aslink"in c||"expand"in c&&!1!==a._more)&&(n=!0);"_icon"in a&&(l=a._icon);"_icon2"in a&&(t=a._icon2);0==l.length&&"_online"in a&&(a._icon=l="img_globe");0==l.length&&f&&(a._icon=l="img_base");if(a._more||"_expand"in a||"_player"in a)n=!0;var y=n;y||"string"!=typeof a._kind||
0!=a._kind.indexOf("ROOT.")||(y=n=!0);0==t.length&&(t=l);0==l.length&&(l=e||a._more?"img_folder":"img_page");0==t.length&&(t=e||a._more?"img_folderopen":"img_page");"update"===d?b.selectAll("*").remove():(b=b.append("div"),d&&d>=(a._parent._show_limit||h.gStyle.HierarchyLimit)&&(p=!0));a._d3cont=b.node();b.attr("item",m);for(var k=b.append("div").attr("class","h_line"),u=f?null:a._parent;u&&u!==this.h;)k.insert("div",":first-child").attr("class",this.isLastSibling(u)?"img_empty":"img_line"),u=u._parent;
var q="";u=!1;f||(e&&!p?(q=a._isopen?"img_minus":"img_plus",u=!0):q="img_join");var w=this;if(0<q.length){if(p||this.isLastSibling(a))q+="bottom";q=k.append("div").attr("class",q);if(u)q.style("cursor","pointer").on("click",function(){w.tree_click(this,"plusminus")})}if(this.with_icons&&!p&&(l=a._isopen?t:l,l=0==l.indexOf("img_")?k.append("div").attr("class",l).attr("title",a._kind):k.append("img").attr("src",l).attr("alt","").attr("title",a._kind).style("vertical-align","top").style("width","18px").style("height",
"18px"),"_icon_click"in a||c&&"icon_click"in c))l.on("click",function(){w.tree_click(this,"icon")});c=k.append("a");if(n||e||p)c.attr("class","h_item").on("click",function(){w.tree_click(this)});if(p)return a._break_point=!0,c.attr("title","there are "+(a._parent._childs.length-d)+" more items").text("...more..."),!1;if("disp_kind"in w){h.gStyle.DragAndDrop&&n&&this.enable_dragging(c.node(),m);if(h.gStyle.ContextMenu&&y)c.on("contextmenu",function(){w.tree_contextmenu(this)});c.on("mouseover",function(){w.tree_mouseover(!0,
this)}).on("mouseleave",function(){w.tree_mouseover(!1,this)})}else if(a._direct_context&&h.gStyle.ContextMenu)c.on("contextmenu",function(){w.direct_contextmenu(this)});d=a._name;n="";"_realname"in a&&(d=a._realname);"_title"in a&&(n=a._title);"_fullname"in a&&(n+="  fullname: "+a._fullname);n||(n=d);c.attr("title",n).text(d+("_value"in a?":":"")).style("background",a._background?a._background:null);"_value"in a&&(k=k.append("p"),"_vclass"in a&&k.attr("class",a._vclass),a._isopen||k.html(a._value));
...
"jsroot"),l=0;l<f.length;++l){var t=g.append("button").text("").attr("class","fast_command").attr("item",this.itemFullName(f[l])).attr("title",f[l]._title).on("click",function(){d.ExecuteCommand(m.select(this).attr("item"),this)});"_icon"in f[l]&&t.append("img").attr("src",f[l]._icon)}g=b.append("p").attr("class","jsroot").style("margin-bottom","3px").style("margin-top",0);g.append("a").attr("class","h_button").text("open all").attr("title","open all items in the browser").on("click",d.toggleOpenState.bind(d,
...
null===h.GetUrlOption("nostatus")&&(b=h.findFunction(c._status),(g="function"==typeof b?this.CreateStatusLine():null)&&b(g,this.itemFullName(c)));h.CallBack(a)};k.prototype.UpdateTreeNode=function(a,b){if(void 0===b||b.empty()){b=m.select(a._d3cont?a._d3cont:null);var d=this.itemFullName(a);b.empty()&&(b=this.select_main().select("[item='"+d+"']"));b.empty()&&"_cycle"in a&&(b=this.select_main().select("[item='"+d+";"+a._cycle+"']"));if(b.empty())return}this.addItemHtml(a,b,"update");this.brlayout&&
this.brlayout.AdjustBrowserSize(!0)};k.prototype.UpdateBackground=function(a,b){if(a&&a._d3cont){var d=m.select(a._d3cont);d.empty()||(d=d.select(".h_item"),d.style("background",a._background?a._background:null),b&&a._background&&d.node().scrollIntoView(!1))}};k.prototype.tree_click=function(a,b){if(a){var d=m.select(a.parentNode.parentNode),c=d.attr("item"),e=c?this.Find(c):null;if(e)if(e._break_point){delete e._break_point;this.addItemHtml(e,d,"update");var g=e._parent;e=g._childs.indexOf(e);d=
m.select(d.node().parentNode);if(0>e)return console.error("internal error");g._show_limit=2*(g._show_limit||h.gStyle.HierarchyLimit);for(e+=1;e<g._childs.length&&(c=g._childs[e],c._parent=g,this.addItemHtml(c,d,e));++e);}else{g=e;for(var l=void 0;g&&void 0===(l=g._click_action);)g=g._parent;b&&""!=b||(b="item");var t=h.getDrawSettings(e._kind);g=t.handle;if("icon"==b)c=null,"function"==typeof e._icon_click?c=e._icon_click:g&&"function"==typeof g.icon_click&&(c=g.icon_click),c&&c(e,this)&&this.UpdateTreeNode(e,
d);else{"item"==b&&"_expand"in e&&!m.event.ctrlKey&&!m.event.shiftKey&&(b="plusminus");if("plusminus"==b&&!("_childs"in e)&&e._more||"item"==b&&"expand"===l)return this.expand(c,null,d);if("item"==b){if("_player"in e)return this.player(c);if(g&&g.aslink)return window.open(c+"/");if(g&&g.execute)return this.ExecuteCommand(c,a.parentNode);if(g&&g.ignore_online&&this.isOnlineItem(e))return;a=e._can_draw;b=e._more;l="expand"===this.default_by_click;var n="";m.event.shiftKey&&(n=g&&g.shift?g.shift:"inspect",
"inspect"===n&&g&&g.noinspect&&(n=""));g&&g.ctrl&&m.event.ctrlKey&&(n=g.ctrl);if(!n)for(var p=e._parent;p;p=p._parent)if(p._painter){a=!1;void 0===b&&(b=!1);break}e._childs&&(b=!1);void 0===a&&(a=t.draw);void 0===b&&(b=t.expand);a&&b&&!n&&(l||g&&"expand"===g.dflt?a=!1:this.isItemDisplayed(c)&&(a=!1));if(a)return this.display(c,n);if(b||l)return this.expand(c,null,d);if("string"===typeof e._kind&&0===e._kind.indexOf("ROOT.")&&t.inspect&&!1!==a)return this.display(c,"inspect");if(!e._childs||e===this.h)return}e._isopen?
delete e._isopen:e._isopen=!0;this.UpdateTreeNode(e,d)}}}};k.prototype.tree_mouseover=function(a,b){b=m.select(b.parentNode.parentNode).attr("item");var c=this.Find(b);if(c){for(var f,e=c;e&&!f;)f=e._painter,e=e._parent;f&&"function"===typeof f.MouseOverHierarchy&&f.MouseOverHierarchy(a,b,c)}};k.prototype.direct_contextmenu=function(a){m.event.preventDefault();var b=m.select(a.parentNode.parentNode).attr("item"),c=this.Find(b);c&&"function"===typeof this.fill_context&&h.Painter.createMenu(this,function(b){b.painter.fill_context(b,
c);0<b.size()&&(b.tree_node=a.parentNode,b.show(m.event))})};k.prototype.tree_contextmenu=function(a){function b(a){var b=document.createElement("div");b.innerHTML='<a href="'+a.split("&").join("&amp;").split("<").join("&lt;").split('"').join("&quot;")+'">x</a>';return b.firstChild.href}m.event.preventDefault();var c=m.select(a.parentNode.parentNode).attr("item"),f=this.Find(c);if(f){var e=this,g=e.GetOnlineProp(c),l=e.GetFileProp(c);h.Painter.createMenu(e,function(d){if(""!=c||"_jsonfile"in f)if(g)e.FillOnlineMenu(d,
g,c);else{var n=h.getDrawSettings(f._kind,"nosame");f._can_draw&&(n.opts||(n.opts=[""]),0>n.opts.indexOf("")&&n.opts.unshift(""));n.opts&&d.addDrawMenu("Draw",n.opts,function(a){this.display(c,a)});if(l&&n.opts&&!l.localfile){var p=b(l.fileurl);0==p.indexOf(h.source_dir)&&(p=p.slice(h.source_dir.length));p=l.kind+"="+p;if(0<l.itemname.length){var t=l.itemname;0<=t.search(/\+| |,/)&&(t="'"+t+"'");p+="&item="+t}d.addDrawMenu("Draw in new tab",n.opts,function(a){window.open(h.source_dir+"index.htm?nobrowser&"+
p+"&opt="+a)})}!n.expand||"_childs"in f||!f._more&&"_more"in f||d.add("Expand",function(){e.expand(c)});"ROOT.TStyle"===f._kind&&d.add("Apply",function(){e.ApplyStyle(c)})}else{n=function(){return 0<q++?"&":"?"};var k="",q=0,u=[];e.ForEachRootFile(function(a){u.push(a._file.fFullURL)});e.GetTopOnlineItem()||(k=h.source_dir+"index.htm");e.IsMonitoring()&&(k+=n()+"monitoring="+e.MonitoringInterval());1==u.length?k+=n()+"file="+u[0]:1<u.length&&(k+=n()+"files="+JSON.stringify(u));e.disp_kind&&(k+=n()+
"layout="+e.disp_kind.replace(/ /g,""));var r=[];e.disp&&e.disp.ForEachPainter(function(a){null!=a.GetItemName()&&r.push(a.GetItemName())});1==r.length?k+=n()+"item="+r[0]:1<r.length&&(k+=n()+"items="+JSON.stringify(r));d.add("Direct link",function(){window.open(k)});d.add("Only items",function(){window.open(k+"&nobrowser")})}"function"==typeof f._menu&&f._menu(d,f,e);0<d.size()&&(d.tree_node=a.parentNode,d.separ&&d.add("separator"),d.add("Close"),d.show(m.event))});return!1}};k.prototype.CreateDisplay=
function(a){if("disp"in this){if(0<this.disp.NumDraw())return h.CallBack(a,this.disp);this.disp.Reset();delete this.disp}if(null==document.getElementById(this.disp_frameid))return h.CallBack(a,null);"tabs"==this.disp_kind?this.disp=new r(this.disp_frameid):0==this.disp_kind.indexOf("flex")?this.disp=new x(this.disp_frameid):0==this.disp_kind.indexOf("coll")?this.disp=new q(this.disp_frameid):this.disp=new h.GridDisplay(this.disp_frameid,this.disp_kind);this.disp&&(this.disp.CleanupFrame=this.CleanupFrame.bind(this));
...
e.find(".gui_localFile").change(function(a){a=a.target.files;for(var b=0;b<a.length;++b){var c=a[b];f.select(".gui_urlToLoad").property("value",c.name);p&&p.OpenRootFile(c,v)}v=null}),this.SelectLocalFile=function(a){v=a;c("#"+this.gui_div+" .jsroot_browser").find(".gui_localFile").click()});g=e.find(".gui_layout");if(g.length){n="simple;vert2;vert3;vert231;horiz2;horiz32;flex;grid 2x2;grid 1x3;grid 2x3;grid 3x3;grid 4x4;collapsible;tabs".split(";");for(k=0;k<n.length;++k)l=document.createElement("option"),
l.value=n[k],l.innerHTML=n[k],g.get(0).appendChild(l);g.change(function(){p.SetDisplay(c(this).val()||"collapsible",p.gui_div+"_drawing")})}this.SetDivId(this.gui_div+"_browser_hierarchy");b&&(this.RefreshHtml(),this.InitializeBrowser());this.brlayout.ToggleBrowserKind(a||"fix");h.CallBack(d);return!0};k.prototype.InitializeBrowser=function(){var a=m.select("#"+this.gui_div+" .jsroot_browser");if(!a.empty()&&this.brlayout){var b=c(a.node()),d=this;this.brlayout&&this.brlayout.AdjustBrowserSize();
...
d.updateAll(!this.checked)});else if(!this.no_select){var h="";this.ForEachRootFile(function(a){h||(h=a._fullurl)});b.find(".gui_urlToLoad").val(h)}}};k.prototype.EnableMonitoring=function(a){this.SetMonitoring(void 0,a);var b=m.select("#"+this.gui_div+" .jsroot_browser .gui_monitoring");b.empty()||b.property("checked")===a||b.property("checked",a)};k.prototype.CreateStatusLine=function(a,b){return!this.status_disabled&&this.gui_div&&this.brlayout?this.brlayout.CreateStatusLine(a,b):""};h.BuildGUI=
function(){var a=m.select("#simpleGUI"),b=!1;if(a.empty()){a=m.select("#onlineGUI");if(a.empty())return alert("no div for gui found");b=!0}"true"===a.attr("ignoreurl")&&(h.gStyle.IgnoreUrlOptions=!0);if(null!==h.GetUrlOption("nobrowser")||a.attr("nobrowser")&&"false"!==a.attr("nobrowser"))return h.BuildNobrowserGUI();h.Painter.readStyleFromURL();var c=new h.HierarchyPainter("root",null);c.is_online=b;c.StartGUI(a,c.InitializeBrowser.bind(c))};q.prototype=Object.create(h.MDIDisplay.prototype);q.prototype.ForEachFrame=
function(a,b){var d=this.frameid+"_collapsible";null!=document.getElementById(d)&&"function"==typeof a&&c("#"+d+" .collapsible_draw").each(function(){b&&c(this).is(":hidden")||a(c(this).get(0))})};q.prototype.GetActiveFrame=function(){var a=h.MDIDisplay.prototype.GetActiveFrame.call(this);if(a&&!c(a).is(":hidden"))return a;a=null;this.ForEachFrame(function(b){a||(a=b)},!0);return a};q.prototype.ActivateFrame=function(a){c(a).is(":hidden")&&c(a).prev().toggleClass("ui-accordion-header-active ui-state-active ui-state-default ui-corner-bottom").find("> .ui-icon").toggleClass("ui-icon-triangle-1-e ui-icon-triangle-1-s").end().next().toggleClass("ui-accordion-content-active").slideDown(0);
c(a).prev()[0].scrollIntoView();this.active_frame_title=m.select(a).attr("frame_title")};q.prototype.CreateFrame=function(a){this.BeforeCreateFrame(a);var b=this.frameid+"_collapsible";null==document.getElementById(b)&&c("#"+this.frameid).append('<div id="'+b+'" class="jsroot ui-accordion ui-accordion-icons ui-widget ui-helper-reset" style="overflow:auto; overflow-y:scroll; height:100%; padding-left: 2px; padding-right: 2px"></div>');var d=this,f=b+"_sub"+this.cnt++,e=f+"h",g='<h5 id="'+e+"\"><span class='ui-icon ui-icon-triangle-1-e'></span><a> "+
...
return c("#"+f).attr("frame_title",a).css("overflow","hidden").attr("can_resize","height").css("position","relative").get(0)};r.prototype=Object.create(h.MDIDisplay.prototype);r.prototype.ForEachFrame=function(a,b){var d=this.frameid+"_tabs";if(null!=document.getElementById(d)&&"function"==typeof a){var f=-1,e=c("#"+d).tabs("option","active");c("#"+d+"> .tabs_draw").each(function(){f++;b&&f!=e||a(c(this).get(0))})}};r.prototype.GetActiveFrame=function(){var a=null;this.ForEachFrame(function(b){a||
(a=b)},!0);return a};r.prototype.ActivateFrame=function(a){var b=0,d=-1;this.ForEachFrame(function(f){c(f).attr("id")==c(a).attr("id")&&(d=b);b++});c("#"+this.frameid+"_tabs").tabs("option","active",d);this.active_frame_title=m.select(a).attr("frame_title")};r.prototype.CreateFrame=function(a){this.BeforeCreateFrame(a);var b=this,d=this.frameid+"_tabs",f=d+"_sub"+this.cnt++,e='<li><a href="#'+f+'">'+a+'</a><span class="ui-icon ui-icon-close" style="float: left; margin: 0.4em 0.2em 0 0; cursor: pointer;" role="presentation">Remove Tab</span></li>',
g='<div class="tabs_draw" id="'+f+'"></div>';if(null==document.getElementById(d)){c("#"+this.frameid).append('<div id="'+d+'" class="jsroot"> <ul>'+e+" </ul>"+g+"</div>");var l=c("#"+d).css("overflow","hidden").tabs({heightStyle:"fill",activate:function(a,b){c(b.newPanel).css("overflow","hidden");h.resize(c(b.newPanel).get(0))}});l.delegate("span.ui-icon-close","click",function(){var a=c(this).closest("li").remove().attr("aria-controls");b.CleanupFrame(a);c("#"+a).remove();l.tabs("refresh");0==c("#"+
d+"> .tabs_draw").length&&c("#"+d).remove()})}else c("#"+d).find("> .ui-tabs-nav").append(e),c("#"+d).append(g),c("#"+d).tabs("refresh"),c("#"+d).tabs("option","active",-1);c("#"+f).empty().css("overflow","hidden").attr("frame_title",a);return c("#"+f).get(0)};r.prototype.CheckMDIResize=function(a,b){c("#"+this.frameid+"_tabs").tabs("refresh");h.MDIDisplay.prototype.CheckMDIResize.call(this,a,b)};x.prototype=Object.create(h.MDIDisplay.prototype);x.prototype.ForEachFrame=function(a,b){var d=this.frameid+
"_flex";null!=document.getElementById(d)&&"function"==typeof a&&c("#"+d+" .flex_draw").each(function(){b&&c(this).is(":hidden")||a(c(this).get(0))})};x.prototype.GetActiveFrame=function(){var a=h.MDIDisplay.prototype.GetActiveFrame.call(this);if(a&&!c(a).is(":hidden"))return a;a=null;this.ForEachFrame(function(b){a||(a=b)},!0);return a};x.prototype.ActivateFrame=function(a){this.active_frame_title=m.select(a).attr("frame_title")};x.prototype.CreateFrame=function(a){function b(a){if("first"===a&&(a=
...
d(a,b?"minimal":"normal")});c("#"+n).find(".ui-resizable-handle").css("z-index","");this.cnt++;return c("#"+n+"_cont").attr("frame_title",a).get(0)};h.GridDisplay.prototype.CreateSeparator=function(a,b,d){b=c(b.append("div").node());b.toggleClass("jsroot_separator",!0).toggleClass(a.vertical?"jsroot_hline":"jsroot_vline",!0).prop("handle",a).attr("separator-id",d.id).css("position","absolute").css(a.vertical?"top":"left","calc("+d.position+"% - 2px)").css(a.vertical?"width":"height",(a.size||100)+
...
function(a,b,c){h.redraw(f.drawid,a,b)})}};a.PerformDraw=function(){function a(){h.NewHttpRequest(f,"object",function(a){a&&(h.cleanup(q.drawid),h.draw(q.drawid,a,l))}).send()}if(this.local_tree)return this.PerformLocalDraw();var d=c(this.select_main().node()),f=this.url+"/exe.json.gz?compact=3&method=Draw",e=d.find(".treedraw_varexp").val(),g="h_tree_draw",l="",k=e.indexOf(">>");0>k?e+=">>"+g:(g=e.substr(k+2),"+"==g[0]&&(g=g.substr(1)),k=g.indexOf("("),0<k&&(g=g.substr(0,k)));if(0==d.find(".treedraw_more").length){k=
d.find(".treedraw_cut").val();var n=d.find(".treedraw_number").val(),m=d.find(".treedraw_first").val();l=d.find(".treedraw_opt").val();f+='&prototype="const char*,const char*,Option_t*,Long64_t,Long64_t"&varexp="'+e+'"&selection="'+k+'"';""==n&&(n=394499<=this.root_version?"TTree::kMaxEntries":"1000000000");""==m&&(m="0");f+='&option="'+l+'"&nentries='+n+"&firstentry="+m}else f+='&prototype="Option_t*"&opt="'+e+'"';f+="&_ret_object_="+g;var q=this;this.askey?(this.askey=!1,h.NewHttpRequest(this.url+
"/root.json","text",a).send()):a()};a.CheckResize=function(a){var b=c(this.select_main().node());c("#"+this.drawid).width(b.width());a=b.height();var f=b.find(".treedraw_buttons").outerHeight(!0);b=b.find("hr").outerHeight(!0);c("#"+this.drawid).height(a-f-b-2);h.resize(this.drawid)};return a};h.drawTreePlayer=function(a,b,c,f){var d=a.Find(b),g=a.GetTopOnlineItem(d),k="",q=0;if(!d||!g)return null;if(f){for(k=d._name;d&&!d._ttree;)d=d._parent;if(!d)return null;b=a.itemFullName(d)}var n=a.GetOnlineItemUrl(b);
if(!n)return null;g=g._root_version?parseInt(g._root_version):396545;a=a.GetDisplay();if(!a)return null;a=a.FindFrame(b,!0);if(!a)return null;a=m.select(a).attr("id");var p=new h.TBasePainter;if(d._childs&&!f)for(f=0;f<d._childs.length;++f){var r=d._childs[f];r&&r._kind&&0==r._kind.indexOf("ROOT.TLeaf")&&2>q&&(0<q++&&(k+=":"),k+=r._name)}h.CreateTreePlayer(p);p.ConfigureOnline(b,n,c,g,k);p.Show(a);return p};h.drawTreePlayerKey=function(a,b){return h.drawTreePlayer(a,b,!0)};h.drawLeafPlayer=function(a,
