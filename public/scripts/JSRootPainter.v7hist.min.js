...
B){function f(a){m.TObjectPainter.call(this,a);this.csstype="hist";this.draw_content=!0;this.nbinsy=this.nbinsx=0;this.accept_drops=!0;this.mode3d=!1;this.zoom_changed_interactive=0}function y(a){f.call(this,a);this.wheel_zoomy=!1}function q(a){f.call(this,a);this.fContour=null;this.fCustomContour=!1;this.fPalette=null;this.wheel_zoomy=!0}m.sources.push("v7hist");f.prototype=Object.create(m.TObjectPainter.prototype);f.prototype.PrepareFrame=function(a){this.SetDivId(a,-1);if(!this.frame_painter()){var c=
this.root_pad();m.v7.drawFrame(a,c?c.fFrame:null)}this.SetDivId(a,1)};f.prototype.GetHImpl=function(a){return a&&a.fHistImpl?a.fHistImpl.fIO:null};f.prototype.GetHisto=function(){var a=this.GetObject();(a=this.GetHImpl(a))&&!a.getBinContent&&(console.log("histo type",a._typename),a.fAxes._1?(a.getBin=function(a,b){return a+this.fAxes._0.fNBins*b},a.getBinContent=function(a,b){return this.fStatistics.fBinContent[this.getBin(a,b)]},a.getBinError=function(a,b){a=this.getBin(a,b);return this.fStatistics.fSumWeightsSquared?
...
function(){var a=this.frame_painter();if(!a)return!1;this.is_main_painter()&&this.draw_content&&(a.CleanupAxes(),a.xmin=a.xmax=0,a.ymin=a.ymax=0,a.zmin=a.zmax=0,a.SetAxesRanges(this.xmin,this.xmax,this.ymin,this.ymax));return a.DrawAxes(!0)};f.prototype.CheckHistDrawAttributes=function(){this.createAttFill({pattern:0,color:0});var a=this.v7EvalColor("line_color","black"),c=this.v7EvalAttr("line_width",1);this.createAttLine({color:a||"black",width:parseInt(c)||1})};f.prototype.UpdateObject=function(a,
c){c=this.GetObject();if(a!==c){if(!this.MatchObjectType(a))return!1;c=this.GetHImpl(c);a=this.GetHImpl(a);if(!c||!a)return!1;c.fStatistics=a.fStatistics}this.ScanContent();return this.histogram_updated=!0};f.prototype.GetAxis=function(a){var c=this.GetHisto();if(!c||!c.fAxes)return null;var b=c.fAxes._0;switch(a){case "x":b=c.fAxes._0;break;case "y":b=c.fAxes._1;break;case "z":b=c.fAxes._2}if(!b||b.GetBinCoord)return b;"ROOT::Experimental::RAxisEquidistant"==b._typename?(b.min=b.fLow,b.max=b.fLow+
(b.fNBins-2)/b.fInvBinWidth,b.GetBinCoord=function(a){return this.fLow+a/this.fInvBinWidth},b.FindBin=function(a,b){return Math.floor((a-this.fLow)*this.fInvBinWidth+b)}):(b.min=b.fBinBorders[0],b.max=b.fBinBorders[b.fNBins-2],b.GetBinCoord=function(a){var b=Math.round(a);if(0>=b)return this.fBinBorders[0];if(b>this.fNBins-2)return this.fBinBorders[this.fNBins-2];if(b==a)return this.fBinBorders[b];var c=a<b?b-1:b+1;return this.fBinBorders[b]*Math.abs(a-c)+this.fBinBorders[c]*Math.abs(a-b)},b.FindBin=
function(a,b){for(var c=1;c<this.fBinBorders.length;++c)if(a<this.fBinBorders[c])return Math.floor(c-1+b);return this.fNBins-2});return b};f.prototype.CreateAxisFuncs=function(a,c){if(this.GetHisto()){var b=this.GetAxis("x");this.xmin=b.min;this.xmax=b.max;a&&this.nbinsy&&(b=this.GetAxis("y"),this.ymin=b.min,this.ymax=b.max,c&&this.nbinsz&&(b=this.GetAxis("z"),this.zmin=b.min,this.zmax=b.max))}};f.prototype.AddInteractive=function(){if(this.is_main_painter()){var a=this.frame_painter();a&&a.AddInteractive()}};
f.prototype.DrawBins=function(){alert("HistPainter.DrawBins not implemented")};f.prototype.ToggleTitle=function(a){return!1};f.prototype.DrawTitle=function(){};f.prototype.UpdateStatWebCanvas=function(){};f.prototype.ToggleStat=function(a){};f.prototype.GetSelectIndex=function(a,c,b){var d=this.frame_painter(),g=this.GetAxis(a),p=this["nbins"+a]||0,l=d?d["zoom_"+a+"min"]:0;a=d?d["zoom_"+a+"max"]:0;l!==a&&g?(c="left"==c?g.FindBin(l,b||0):g.FindBin(a,(b||0)+.5),0>c?c=0:c>p&&(c=p)):c="left"==c?0:p;return c};
f.prototype.FindStat=function(){return null};f.prototype.IgnoreStatsFill=function(){return!0};f.prototype.CreateStat=function(a){return null};f.prototype.ButtonClick=function(a){switch(a){case "ToggleZoom":if(this.zoom_xmin!==this.zoom_xmax||this.zoom_ymin!==this.zoom_ymax||this.zoom_zmin!==this.zoom_zmax){this.Unzoom();if(a=this.frame_painter())a.zoom_changed_interactive=0;return!0}if(this.draw_content&&"function"===typeof this.AutoZoom)return this.AutoZoom(),!0;break;case "ToggleLogX":this.frame_painter().ToggleLog("x");
break;case "ToggleLogY":this.frame_painter().ToggleLog("y");break;case "ToggleLogZ":this.frame_painter().ToggleLog("z");break;case "ToggleStatBox":return this.ToggleStat(),!0}return!1};f.prototype.FillToolbar=function(a){var c=this.pad_painter();c&&(c.AddButton(m.ToolbarIcons.auto_zoom,"Toggle between unzoom and autozoom-in","ToggleZoom","Ctrl *"),c.AddButton(m.ToolbarIcons.arrow_right,"Toggle log x","ToggleLogX","PageDown"),c.AddButton(m.ToolbarIcons.arrow_up,"Toggle log y","ToggleLogY","PageUp"),
1<this.Dimension()&&c.AddButton(m.ToolbarIcons.arrow_diag,"Toggle log z","ToggleLogZ"),this.draw_content&&c.AddButton(m.ToolbarIcons.statbox,"Toggle stat box","ToggleStatBox"),a||c.ShowButtons())};f.prototype.Get3DToolTip=function(a){var c=this.GetHisto(),b={bin:a,name:c.fName||"histo",title:c.fTitle};switch(this.Dimension()){case 1:b.ix=a;b.iy=1;b.value=c.getBinContent(b.ix);b.error=c.getBinError(a);b.lines=this.GetBinTips(a-1);break;case 2:b.ix=a%(this.nbinsx+2);b.iy=(a-b.ix)/(this.nbinsx+2);b.value=
c.getBinContent(b.ix,b.iy);b.error=c.getBinError(a);b.lines=this.GetBinTips(b.ix-1,b.iy-1);break;case 3:b.ix=a%(this.nbinsx+2),b.iy=(a-b.ix)/(this.nbinsx+2)%(this.nbinsy+2),b.iz=(a-b.ix-b.iy*(this.nbinsx+2))/(this.nbinsx+2)/(this.nbinsy+2),b.value=this.GetObject().getBinContent(b.ix,b.iy,b.iz),b.error=c.getBinError(a),b.lines=this.GetBinTips(b.ix-1,b.iy-1,b.iz-1)}return b};f.prototype.CreateContour=function(a,c,b,d){1>a&&(a=m.gStyle.fNumberContours);this.fContour=[];this.colzmin=c;this.colzmax=b;
if(this.root_pad().fLogz){0>=this.colzmax&&(this.colzmax=1);0>=this.colzmin&&(this.colzmin=void 0===d||0>=d?1E-4*this.colzmax:3>d||100<d?.3*d:1);this.colzmin>=this.colzmax&&(this.colzmin=1E-4*this.colzmax);c=Math.log(this.colzmin)/Math.log(10);b=(Math.log(this.colzmax)/Math.log(10)-c)/a;this.fContour.push(this.colzmin);for(d=1;d<a;d++)this.fContour.push(Math.exp((c+b*d)*Math.log(10)));this.fContour.push(this.colzmax);this.fCustomContour=!0}else for(this.colzmin===this.colzmax&&0!==this.colzmin&&(this.colzmax+=
.01*Math.abs(this.colzmax),this.colzmin-=.01*Math.abs(this.colzmin)),b=(this.colzmax-this.colzmin)/a,d=0;d<=a;d++)this.fContour.push(this.colzmin+b*d);a=this.frame_painter();3>this.Dimension()&&(a.zmin=this.zmin=this.colzmin,a.zmax=this.zmax=this.colzmax);a.fContour=this.fContour;a.fCustomContour=this.fCustomContour;a.colzmin=this.colzmin;a.colzmax=this.colzmax;return this.fContour};f.prototype.GetContour=function(){if(this.fContour)return this.fContour;var a=this.frame_painter();if(a&&a.fContour)return this.fContour=
a.fContour,this.fCustomContour=a.fCustomContour,this.colzmin=a.colzmin,this.colzmax=a.colzmax,this.fContour;this.GetHisto();var c=m.gStyle.fNumberContours,b=this.minbin,d=this.maxbin,g=this.minposbin;b===d&&(b=this.gminbin,d=this.gmaxbin,g=this.gminposbin);a.zoom_zmin!=a.zoom_zmax&&(b=a.zoom_zmin,d=a.zoom_zmax);this.fCustomContour=!1;return this.CreateContour(c,b,d,g)};f.prototype.FillContextMenu=function(a){this.GetHisto();a.add("header:v7histo::anyname");this.draw_content&&(a.addchk(this.ToggleStat("only-check"),
"Show statbox",function(){this.ToggleStat()}),"function"==typeof this.FillHistContextMenu&&this.FillHistContextMenu(a));if(this.options.Mode3D){0<a.size()&&a.add("separator");var c=this.main_painter()||this,b=this.frame_painter();a.addchk(c.IsTooltipAllowed(),"Show tooltips",function(){c.SetTooltipAllowed("toggle")});a.addchk(b.enable_highlight,"Highlight bins",function(){b.enable_highlight=!b.enable_highlight;!b.enable_highlight&&c.BinHighlight3D&&c.mode3d&&c.BinHighlight3D(null)});b&&b.Render3D&&
(a.addchk(c.options.FrontBox,"Front box",function(){c.options.FrontBox=!c.options.FrontBox;b.Render3D()}),a.addchk(c.options.BackBox,"Back box",function(){c.options.BackBox=!c.options.BackBox;b.Render3D()}));this.draw_content&&(a.addchk(!this.options.Zero,"Suppress zeros",function(){this.options.Zero=!this.options.Zero;this.RedrawPad()}),12==this.options.Lego||14==this.options.Lego)&&(a.addchk(this.options.Zscale,"Z scale",function(){this.ToggleColz()}),this.FillPaletteMenu&&this.FillPaletteMenu(a));
c.control&&"function"===typeof c.control.reset&&a.add("Reset camera",function(){c.control.reset()})}this.FillAttContextMenu(a);this.histogram_updated&&this.zoom_changed_interactive&&a.add("Let update zoom",function(){this.zoom_changed_interactive=0});return!0};f.prototype.getContourIndex=function(a){var c=this.GetContour();if(this.fCustomContour){var b=0,d=c.length-1;if(a<c[0])return-1;if(a>=c[d])return d;for(;b<d-1;){var g=Math.round((b+d)/2);c[g]>a?d=g:b=g}return b}return a<this.colzmin?this.options.Zero?
-1:0:a===this.colzmin?0!=this.colzmin||!this.options.Zero||this.IsTH2Poly()?0:-1:Math.floor(.01+(a-this.colzmin)*(c.length-1)/(this.colzmax-this.colzmin))};f.prototype.getContourColor=function(a,c){var b=this.getContourIndex(a);if(0>b)return null;var d=this.GetContour();a=this.GetPalette();b=a.calcColorIndex(b,d.length);return c?b:a.getColor(b)};f.prototype.GetPalette=function(a){if(!this.fPalette||a)this.fPalette=this.get_palette(!0,this.options.Palette);return this.fPalette};f.prototype.FillPaletteMenu=
function(a){function c(a){g.options.Palette=parseInt(a);g.GetPalette(!0);g.Redraw()}function b(b,g,e){a.addchk(b===d||e,"<nobr>"+g+"</nobr>",b,c)}var d=this.options.Palette,g=this;if(null===d||0===d)d=m.gStyle.Palette;a.add("sub:Palette");b(50,"ROOT 5",10<=d&&51>d);b(51,"Deep Sea");b(52,"Grayscale",0<d&&10>d);b(53,"Dark body radiator");b(54,"Two-color hue");b(55,"Rainbow");b(56,"Inverted dark body radiator");b(57,"Bird",112<d);b(58,"Cubehelix");b(59,"Green Red Violet");b(60,"Blue Red Yellow");b(61,
"Ocean");b(62,"Color Printable On Grey");b(63,"Alpine");b(64,"Aquamarine");b(65,"Army");b(66,"Atlantic");a.add("endsub:")};f.prototype.DrawColorPalette=function(a,c,b){return null};f.prototype.ToggleColz=function(){if(this.options.Mode3D?12===this.options.Lego||14===this.options.Lego||11===this.options.Surf||12===this.options.Surf:this.options.Color||this.options.Contour)this.options.Zscale=!this.options.Zscale,this.DrawColorPalette(this.options.Zscale,!1,!0)};f.prototype.ToggleMode3D=function(){this.options.Mode3D=
!this.options.Mode3D;!this.options.Mode3D||this.options.Surf||this.options.Lego||this.options.Error||(this.options.Lego=50<=this.nbinsx||50<=this.nbinsy?this.options.Color?14:13:this.options.Color?12:1,this.options.Zero=!1);this.CopyOptionsToOthers();this.InteractiveRedraw("pad","drawopt")};f.prototype.PrepareColorDraw=function(a){a||(a={rounding:!0,extra:0,middle:0});void 0===a.extra&&(a.extra=0);void 0===a.middle&&(a.middle=0);var c=this.GetHisto(),b=this.GetAxis("x"),d=this.GetAxis("y"),g=this.frame_painter(),
p=this.Dimension(),l,e={i1:this.GetSelectIndex("x","left",0-a.extra),i2:this.GetSelectIndex("x","right",1+a.extra),j1:1===p?0:this.GetSelectIndex("y","left",0-a.extra),j2:1===p?1:this.GetSelectIndex("y","right",1+a.extra),min:0,max:0,sumz:0,xbar1:0,xbar2:1,ybar1:0,ybar2:1};e.grx=new Float32Array(e.i2+1);e.gry=new Float32Array(e.j2+1);a.original&&(e.original=!0,e.origx=new Float32Array(e.i2+1),e.origy=new Float32Array(e.j2+1));a.pixel_density&&(a.rounding=!0);for(l=e.i1;l<=e.i2;++l){var k=b.GetBinCoord(l+
a.middle);g.logx&&0>=k?e.i1=l+1:(e.origx&&(e.origx[l]=k),e.grx[l]=g.grx(k),a.rounding&&(e.grx[l]=Math.round(e.grx[l])),a.use3d&&(e.grx[l]<-g.size_xy3d&&(e.i1=l,e.grx[l]=-g.size_xy3d),e.grx[l]>g.size_xy3d&&(e.i2=l,e.grx[l]=g.size_xy3d)))}if(1===p)e.gry[0]=g.gry(0),e.gry[1]=g.gry(1);else for(b=e.j1;b<=e.j2;++b)l=d.GetBinCoord(b+a.middle),g.logy&&0>=l?e.j1=b+1:(e.origy&&(e.origy[b]=l),e.gry[b]=g.gry(l),a.rounding&&(e.gry[b]=Math.round(e.gry[b])),a.use3d&&(e.gry[b]<-g.size_xy3d&&(e.j1=b,e.gry[b]=-g.size_xy3d),
e.gry[b]>g.size_xy3d&&(e.j2=b,e.gry[b]=g.size_xy3d)));c.getBinContent(e.i1+1,e.j1+1);this.maxbin=this.minbin=this.minposbin=null;for(l=e.i1;l<e.i2;++l)for(b=e.j1;b<e.j2;++b){d=c.getBinContent(l+1,b+1);e.sumz+=d;if(a.pixel_density){g=(e.grx[l+1]-e.grx[l])*(e.gry[b]-e.gry[b+1]);if(0>=g)continue;e.max=Math.max(e.max,d);0<d&&(d<e.min||0===e.min)&&(e.min=d);d/=g}null===this.maxbin?this.maxbin=this.minbin=d:(this.maxbin=Math.max(this.maxbin,d),this.minbin=Math.min(this.minbin,d));0<d&&(null===this.minposbin||
d<this.minposbin)&&(this.minposbin=d)}this.fContour=null;this.fCustomContour=!1;return e};y.prototype=Object.create(f.prototype);y.prototype.ConvertTH1K=function(){var a=this.GetObject();if(!a.fReady){var c=a.fArray;a.fNcells=a.fXaxis.fNbins+2;a.fArray=new Float64Array(a.fNcells);for(var b=0;b<a.fNcells;++b)a.fArray[b]=0;for(b=0;b<a.fNIn;++b)a.Fill(c[b]);a.fReady=!0}};y.prototype.ScanContent=function(a){var c=this.GetHisto();if(c){!this.nbinsx&&a&&(a=!1);a||(this.nbinsx=this.GetAxis("x").fNBins-2,
this.nbinsy=0,this.CreateAxisFuncs(!1));var b=this.GetSelectIndex("x","left"),d=this.GetSelectIndex("x","right");if(!a||b!==this.scan_xleft||d!==this.scan_xright){this.scan_xleft=b;this.scan_xright=d;for(var g=a=0,p=0,l=0,e=!0,k,z=0;z<this.nbinsx;++z)k=c.getBinContent(z+1),l+=k,z<b||z>=d||(0<k&&(0==g||k<g)&&(g=k),e&&(a=p=k,e=!1),a=Math.min(a,k-0),p=Math.max(p,k+0));this.stat_entries=l+=c.getBinContent(0)+c.getBinContent(this.nbinsx+1);this.hmin=a;this.hmax=p;this.ymin_nz=g;if(this.draw_content=0==
this.nbinsx||1E-300>Math.abs(a)&&1E-300>Math.abs(p)?!1:!0)a>=p?0==a?(this.ymin=0,this.ymax=1):0>a?(this.ymin=2*a,this.ymax=0):(this.ymin=0,this.ymax=2*a):(c=.05*(p-a),this.ymin=a-c,0>this.ymin&&0<=a&&(this.ymin=0),this.ymax=p+c)}}};y.prototype.CountStat=function(a){for(var c=this.IsTProfile(),b=this.GetHisto(),d=this.GetAxis("x"),g=this.GetSelectIndex("x","left"),p=this.GetSelectIndex("x","right"),l=0,e=0,k=0,z=0,h=0,n,u,r=null,x=null,t=this.frame_painter(),v={name:"histo",meanx:0,meany:0,rmsx:0,
rmsy:0,integral:0,entries:this.stat_entries,xmax:0,wmax:0};g<p;++g)if(n=d.GetBinCoord(g+.5),!a||a(n)){c?(u=b.fBinEntries[g+1],z+=b.fArray[g+1],h+=b.fSumw2[g+1]):u=b.getBinContent(g+1);if(null===r||u>x)r=n,x=u;l+=u;e+=u*n;k+=u*n*n}!t.IsAxisZoomed("x")&&b.fTsumw&&(l=b.fTsumw,e=b.fTsumwx,k=b.fTsumwx2);v.integral=l;0<l&&(v.meanx=e/l,v.meany=z/l,v.rmsx=Math.sqrt(Math.abs(k/l-v.meanx*v.meanx)),v.rmsy=Math.sqrt(Math.abs(h/l-v.meany*v.meany)));null!==r&&(v.xmax=r,v.wmax=x);return v};y.prototype.FillStatistic=
function(a,c,b){if(this.IgnoreStatsFill())return!1;b=this.CountStat();var d=c%10,g=Math.floor(c/10)%10,p=Math.floor(c/100)%10,l=Math.floor(c/1E3)%10,e=Math.floor(c/1E4)%10,k=Math.floor(c/1E5)%10,z=Math.floor(c/1E6)%10,h=Math.floor(c/1E7)%10;c=Math.floor(c/1E8)%10;a.ClearPave();0<d&&a.AddText(b.name);this.IsTProfile()?(0<g&&a.AddText("Entries = "+a.Format(b.entries,"entries")),0<p&&(a.AddText("Mean = "+a.Format(b.meanx)),a.AddText("Mean y = "+a.Format(b.meany))),0<l&&(a.AddText("Std Dev = "+a.Format(b.rmsx)),
a.AddText("Std Dev y = "+a.Format(b.rmsy)))):(0<g&&a.AddText("Entries = "+a.Format(b.entries,"entries")),0<p&&a.AddText("Mean = "+a.Format(b.meanx)),0<l&&a.AddText("Std Dev = "+a.Format(b.rmsx)),0<e&&a.AddText("Underflow = "+a.Format(histo.getBinContent(0),"entries")),0<k&&a.AddText("Overflow = "+a.Format(histo.getBinContent(this.nbinsx+1),"entries")),0<z&&a.AddText("Integral = "+a.Format(b.integral,"entries")),0<h&&a.AddText("Skew = <not avail>"),0<c&&a.AddText("Kurt = <not avail>"));return!0};y.prototype.DrawBars=
function(a,c){this.CreateG(!0);var b=this.GetSelectIndex("x","left",-1);a=this.GetSelectIndex("x","right",1);var d=this.frame_painter(),g=this.GetHisto(),p=this.GetAxis("x"),l="",e="",k="",z=10<this.options.BarStyle?this.options.BarStyle%10:0;4<z&&(z=4);c=d.swap_xy?0:c;for(!1===this.options.BaseLine||isNaN(this.options.BaseLine)||this.options.BaseLine>=d.scale_ymin&&(c=Math.round(d.gry(this.options.BaseLine)));b<a;++b){var h=p.GetBinCoord(b);var n=p.GetBinCoord(b+1);if(!(d.logx&&0>=n)){h=Math.round(d.grx(h));
n=Math.round(d.grx(n));var u=g.getBinContent(b+1);if(!(d.logy&&u<d.scale_ymin)){u=Math.round(d.gry(u));var r=n-h;h+=Math.round(this.options.fBarOffset/1E3*r);r=Math.round(this.options.fBarWidth/1E3*r);l=d.swap_xy?l+("M"+c+","+h+"h"+(u-c)+"v"+r+"h"+(c-u)+"z"):l+("M"+h+","+u+"h"+r+"v"+(c-u)+"h"+-r+"z");0<z&&(n=h+r,r=Math.round(r*z/10),d.swap_xy?(e+="M"+c+","+h+"h"+(u-c)+"v"+r+"h"+(c-u)+"z",k+="M"+c+","+n+"h"+(u-c)+"v"+-r+"h"+(c-u)+"z"):(e+="M"+h+","+u+"h"+r+"v"+(c-u)+"h"+-r+"z",k+="M"+n+","+u+"h"+-r+
"v"+(c-u)+"h"+r+"z"))}}}this.fillatt.empty()&&this.fillatt.SetSolidColor("blue");0<l.length&&this.draw_g.append("svg:path").attr("d",l).call(this.fillatt.func);0<e.length&&this.draw_g.append("svg:path").attr("d",e).call(this.fillatt.func).style("fill",B.rgb(this.fillatt.color).brighter(.5).toString());0<k.length&&this.draw_g.append("svg:path").attr("d",k).call(this.fillatt.func).style("fill",B.rgb(this.fillatt.color).darker(.5).toString())};y.prototype.DrawFilledErrors=function(a,c){this.CreateG(!0);
var b=this.GetSelectIndex("x","left",-1),d=this.GetSelectIndex("x","right",1),g=this.frame_painter(),p=this.GetHisto(),l=this.GetAxis("x");c=[];for(a=[];b<d;++b){var e=l.GetBinCoord(b+.5);if(!(g.logx&&0>=e)){e=Math.round(g.grx(e));var k=p.getBinContent(b+1);var z=p.getBinError(b+1);if(!(g.logy&&k-z<g.scale_ymin)){var h=Math.round(g.gry(k+z));k=Math.round(g.gry(k-z));c.push({grx:e,gry:h});a.unshift({grx:e,gry:k})}}}d=4===this.options.ErrorKind?"bezier":"line";c=m.Painter.BuildSvgPath(d,c);a=m.Painter.BuildSvgPath("L"+
d,a);this.fillatt.empty()&&this.fillatt.setSolidColor("blue");this.draw_g.append("svg:path").attr("d",c.path+a.path+"Z").style("stroke","none").call(this.fillatt.func)};y.prototype.DrawBins=function(){function a(a){S=k.getBinContent(a+1);C&&0===S||(K=Math.round(l.grx(z.GetBinLowEdge(a+1))),M=Math.round(l.grx(z.GetBinLowEdge(a+2))),P=Math.round((K+M)/2),J=Math.round(l.gry(S)),Q=U=20,w&&(Z=k.getBinError(a+1),Q=Math.round(J-l.gry(S+Z)),U=Math.round(l.gry(S-Z)-J)),q&&(a=y?k.fBinEntries[a+1]:S,0!==a&&
(a=a===Math.round(a)?a.toString():m.FFormat(a,m.gStyle.fPaintTextFormat),V?e.DrawText({align:12,x:P,y:Math.round(J-2-N/5),width:0,height:0,rotate:V,text:a,color:ca,latex:0}):e.DrawText({align:22,x:Math.round(K+.1*(M-K)),y:Math.round(J-2-N),width:Math.round(.8*(M-K)),height:N,text:a,color:ca,latex:0}))),f&&null!==L&&(L+=(0===L.length?"M":"L")+P+","+J),W&&J>=-Q&&J<=b+U&&(null!==D&&(D+="M"+K+","+(J-Q)+"h"+(M-K)+"v"+(Q+U+1)+"h-"+(M-K)+"z"),null!==B&&(B+=e.markeratt.create(P,J)),null!==A&&(0<e.options.errorX&&
(a=Math.round(P-(M-K)*e.options.errorX),A+="M"+(a+X)+","+J+aa+"h"+(Math.round(P+(M-K)*e.options.errorX)-a-2*X)+aa),A+="M"+P+","+(J-Q+X)+ba+"v"+(Q+U-2*X)+ba)))}var c=this.frame_width(),b=this.frame_height(),d=this.options;if(!this.draw_content||0>=c||0>=b)return this.RemoveDrawG();this.CheckHistDrawAttributes();if(d.Bar)return this.DrawBars(c,b);if(3===d.ErrorKind||4===d.ErrorKind)return this.DrawFilledErrors(c,b);this.CreateG(!0);var g=this.GetSelectIndex("x","left",-1),p=this.GetSelectIndex("x",
"right",2),l=this.frame_painter(),e=this,k=this.GetHisto(),z=this.GetAxis("x"),h="",n=!1,u,r,x,t,v,E,C=!d.Zero,w=d.Error;n=d.Mark;var f=d.Line,q=d.Text,y=q&&"E"==this.options.TextKind&&this.IsTProfile()&&k.fBinEntries,D=null,A=null,B=null,L=null,aa="",ba="",X=0,J,Q,U,S,Z,K,M,P;2===d.ErrorKind?this.fillatt.empty()?n=!0:D="":d.Error&&(A="");f&&(L="");n&&(this.createAttMarker({attr:k,style:this.options.MarkStyle}),0<this.markeratt.size?(B="",this.markeratt.reset_pos()):n=!1);if(q){var ca=this.get_color(k.fMarkerColor);
var V=-1*d.TextAngle;var N=20;1!==d.fMarkerSize&&V&&(N=.02*b*d.fMarkerSize);if(!V&&!d.TextKind){var G=c/(p-g+1);G<3*N&&(V=270,N=Math.round(.7*G))}this.StartTextDrawing(42,N,this.draw_g,N)}c=p-g>3*c;1===d.ErrorKind&&(G=this.lineatt.width+m.gStyle.fEndErrorSize,aa="m0,"+G+"v-"+2*G+"m0,"+G,ba="m"+G+",0h-"+2*G+"m"+G+",0",X=Math.floor((this.lineatt.width-1)/2));var W=w||n;if(W||q||f)c=!0;for(G=g;G<=p;++G)if(n=z.GetBinCoord(G),!(l.logx&&0>=n)){var O=Math.round(l.grx(n));if((n=G===p)&&g<p)var I=x;else I=
k.getBinContent(G+1),I=Math.round(l.gry(I));if(0===h.length){var R=E=G;var Y=u=r=O;var T=t=v=x=I;h="M"+r+","+x}else if(c)if(O!==r||n){if(W||q||f)R===E?a(R):R<E?(a(R),a(E)):(a(E),a(R));W||t===v&&T===t||(Y!==r&&(h+="h"+(r-Y)),x===t?(v!==T&&(h+="v"+(v-T)),t!==v&&(h+="v"+(t-v))):(t!==T&&(h+="v"+(t-T)),v!==t&&(h+="v"+(v-t)),x!==v&&(h+="v"+(x-v))),Y=r,T=x);n&&Y!==O&&(h+="h"+(O-Y));R=E=G;t=v=x=I;r=O}else I<t?E=G:I>v&&(R=G),t=Math.min(t,I),v=Math.max(v,I),x=I;else if(I!==x||n)O!==r&&(h+="h"+(O-r)),I!==x&&
(h+="v"+(I-x)),x=I,r=O}g="";this.fillatt.empty()||(g=b+3,p=Math.round(l.gry(0)),0>=p?g=-3:p<b&&(g=p),g="L"+r+","+g+"L"+u+","+g+"Z",0<h.length&&(h+=g));W||f?(null!==D&&0<D.length&&this.draw_g.append("svg:path").attr("d",D).call(this.fillatt.func),null!==A&&0<A.length&&this.draw_g.append("svg:path").attr("d",A).call(this.lineatt.func),null!==L&&0<L.length&&(this.fillatt.empty()||this.draw_g.append("svg:path").attr("d",d.Fill?L+g:h).attr("stroke","none").call(this.fillatt.func),this.draw_g.append("svg:path").attr("d",
L).attr("fill","none").call(this.lineatt.func)),null!==B&&0<B.length&&this.draw_g.append("svg:path").attr("d",B).call(this.markeratt.func)):h&&d.Hist&&this.draw_g.append("svg:path").attr("d",h).style("stroke-linejoin","miter").call(this.lineatt.func).call(this.fillatt.func);q&&this.FinishTextDrawing(this.draw_g)};y.prototype.GetBinTips=function(a){var c=[],b=this.GetTipName(),d=this.frame_painter(),g=this.GetHisto(),p=this.GetAxis("x"),l=p.GetBinCoord(a);p=p.GetBinCoord(a+1);var e=g.getBinContent(a+
1),k=!1;0<b.length&&c.push(b);"labels"===d.x_kind?b=d.AxisAsText("x",l):"time"===d.x_kind?b=d.AxisAsText("x",(l+p)/2):(k=!0,b="["+d.AxisAsText("x",l)+", "+d.AxisAsText("x",p)+")");this.options.Error||this.options.Mark?(c.push("x = "+b),c.push("y = "+d.AxisAsText("y",e)),this.options.Error&&(k&&c.push("error x = "+((p-l)/2).toPrecision(4)),c.push("error y = "+g.getBinError(a+1).toPrecision(4)))):(c.push("bin = "+(a+1)),c.push("x = "+b),g.$baseh&&(e-=g.$baseh.getBinContent(a+1)),e===Math.round(e)?c.push("entries = "+
e):c.push("entries = "+m.FFormat(e,m.gStyle.fStatFormat)));return c};y.prototype.ProcessTooltip=function(a){function c(a){a=e.GetBinCoord(a);return p.logx&&0>=a?null:p.grx(a)}function b(a){a=l.getBinContent(a+1);return p.logy&&a<p.scale_ymin?p.swap_xy?-1E3:10*g:Math.round(p.gry(a))}if(null===a||!this.draw_content||this.options.Mode3D)return null!==this.draw_g&&this.draw_g.select(".tooltip_bin").remove(),null;var d=this.frame_width(),g=this.frame_height(),p=this.frame_painter(),l=this.GetHisto(),e=
this.GetAxis("x"),k=null,z=!0,h,n=2,u=this.GetSelectIndex("x","left",-1),r=this.GetSelectIndex("x","right",2);var x=u;var t=r;for(var v=p.swap_xy?a.y:a.x,m=p.swap_xy?a.x:a.y;x<t-1;){var C=Math.round(.5*(x+t));k=c(C);null===k||k<v-.5?p.swap_xy?t=C:x=C:k>v+.5?p.swap_xy?x=C:t=C:(x++,t--)}k=t=x;C=c(k);if(p.swap_xy){for(;x>u&&c(x-1)<C+2;)--x;for(;t<r&&c(t+1)>C-2;)++t}else{for(;x>u&&c(x-1)>C-2;)--x;for(;t<r&&c(t+1)<C+2;)++t}if(x<t){z=g;for(C=x;C<=t;C++){var w=Math.abs(b(C)-m);w<z&&(z=w,k=C)}z>g/10&&(k=
Math.round(x+(t-x)/g*m));C=c(k)}C=Math.round(C);var f=Math.round(c(k+1));this.options.Bar&&(x=f-C,C+=Math.round(this.options.fBarOffset/1E3*x),f=C+Math.round(this.options.fBarWidth/1E3*x));if(C>f){var q=C;C=f;f=q}x=Math.round((C+f)/2);t=w=h=b(k);if(this.options.Bar)z=!0,n=0,w=Math.round(p.gry(!1!==this.options.BaseLine&&this.options.BaseLine>p.scale_ymin?this.options.BaseLine:p.scale_ymin)),w>h&&(q=w,w=h,h=q),!a.touch&&1===a.nproc&&(m<w||m>h)&&(k=null);else if(this.options.Error||this.options.Mark||
this.options.Line)z=!0,d=3,this.markeratt&&(d=Math.max(d,this.markeratt.GetFullSize())),this.options.Error&&(q=l.getBinContent(k+1),h=l.getBinError(k+1),w=Math.round(p.gry(q+h)),h=Math.round(p.gry(q-h)),0==q&&this.IsTProfile()&&(k=null),f=(f-C)*this.options.errorX,C=Math.round(x-f),f=Math.round(x+f)),f-C<2*d&&(C=x-d,f=x+d),w=Math.min(w,t-d),h=Math.max(h,t+d),!a.touch&&1===a.nproc&&(m<w||m>h)&&(k=null);else if(z=1===a.nproc&&r-u<d)h=g,this.fillatt.empty()||(h=Math.round(p.gry(0)),0>h?h=0:h>g&&(h=g),
h<w&&(q=w,w=h,h=q)),(a.y<w||a.y>h)&&!a.touch&&(k=null);null!==k&&(k===u&&C>v+n?k=null:k===r-1&&f<v-n?k=null:v<C-n||v>f+n?k=null:this.options.Zero||0!==l.getBinContent(k+1)||(k=null));n=this.draw_g.select(".tooltip_bin");if(null===k||0>=h||w>=g)return n.remove(),null;u={name:"histo",title:l.fTitle,x:x,y:t,exact:!0,color1:this.lineatt?this.lineatt.color:"green",color2:this.fillatt?this.fillatt.fillcoloralt("blue"):"blue",lines:this.GetBinTips(k)};a.disabled?(n.remove(),u.changed=!0):z?(n.empty()&&(n=
...
"none").attr("r",v).call(this.lineatt.func).call(this.fillatt.func)),u.exact=Math.abs(x-a.x)<=v&&Math.abs(t-a.y)<=v,u.menu=u.exact,u.menu_dist=Math.sqrt((x-a.x)*(x-a.x)+(t-a.y)*(t-a.y)),u.changed=n.property("current_bin")!==k,u.changed&&n.attr("cx",x).attr("cy",t).property("current_bin",k));u.changed&&(u.user_info={obj:l,name:"histo",bin:k,cont:l.getBinContent(k+1),grx:x,gry:t});return u};y.prototype.FillHistContextMenu=function(a){a.add("Auto zoom-in",this.AutoZoom);var c=m.getDrawSettings("ROOT."+
this.GetObject()._typename,"nosame");a.addDrawMenu("Draw with",c.opts,function(a){if("inspect"===a)return this.ShowInspector();this.DecodeOptions(a);this.options.need_fillcol&&this.fillatt&&this.fillatt.empty()&&this.fillatt.Change(5,1001);this.InteractiveRedraw("pad","drawopt")})};y.prototype.AutoZoom=function(){var a=this.GetSelectIndex("x","left",-1),c=this.GetSelectIndex("x","right",1),b=c-a,d=this.GetHisto(),g=this.GetAxis("x");if(0!=b){for(var p=d.getBinContent(a+1),l=a;l<c;++l)p=Math.min(p,
d.getBinContent(l+1));if(!(0<p)){for(;a<c&&d.getBinContent(a+1)<=p;)++a;for(;a<c&&d.getBinContent(c)<=p;)--c;a===c-1&&2<a&&c<this.nbinsx-2&&(--a,++c);c-a<b&&a<c&&this.frame_painter().Zoom(g.GetBinCoord(a),g.GetBinCoord(c))}}};y.prototype.CanZoomIn=function(a,c,b){var d=this.GetAxis("x");return"x"==a&&1<d.FindBin(b,.5)-d.FindBin(c,0)||"y"==a&&Math.abs(b-c)>1E-6*Math.abs(this.ymax-this.ymin)?!0:!1};y.prototype.CallDrawFunc=function(a,c){var b=this.frame_painter();b&&b.mode3d!==this.options.Mode3D&&
(this.options.Mode3D=b.mode3d);this[this.options.Mode3D?"Draw3D":"Draw2D"](a,c)};y.prototype.Draw2D=function(a){this.Clear3DScene();this.mode3d=!1;"function"===typeof this.DrawColorPalette&&this.DrawColorPalette(!1);this.DrawAxes()?this.DrawBins():console.log("FAIL DARWING AXES");this.AddInteractive();m.CallBack(a)};y.prototype.Draw3D=function(a,c){this.mode3d=!0;m.AssertPrerequisites("hist3d",function(){this.Draw3D(a,c)}.bind(this))};y.prototype.Redraw=function(a){this.CallDrawFunc(null,a)};q.prototype=
Object.create(f.prototype);q.prototype.Cleanup=function(){delete this.fCustomContour;delete this.tt_handle;f.prototype.Cleanup.call(this)};q.prototype.Dimension=function(){return 2};q.prototype.ToggleProjection=function(a,c){"Projections"==a&&(a="");"string"==typeof a&&1<a.length&&(c=parseInt(a.substr(1)),a=a[0]);c||(c=1);if(a&&this.is_projection==a)if(this.projection_width===c)a="";else{this.projection_width=c;return}delete this.proj_hist;a=this.is_projection===a?"":a;this.is_projection="";this.projection_width=
